...
public class Lumpia extends Activity {
    WebView webView;
    String	myLati="-7.419065";
    String	myLongi="109.221911";
    String myPosisi="Stasiun Purwokerto";

    String	myLati2="-7.421854";
    String	myLongi2="109.227400";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.lumpia);

        rute = (Button) findViewById(R.id.buttonrute);
        ...
        webView.loadUrl("file:///android_asset/lumpiapurwokerto.html");
        return;
