...
public class GetukGoreng extends Activity {
    WebView webView;
    ...
    String	myLati2="-7.427932";
    String	myLongi2="109.241243";
    String myPosisi2="Getuk Goreng Sari Asli";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.getukgoreng);

        rute = (Button) findViewById(R.id.btnrute);
        ...
        webView.loadUrl("file:///android_asset/getukgoreng.html");
        return;
